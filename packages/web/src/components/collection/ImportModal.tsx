        ...
        <div className="bg-bg-secondary rounded-lg shadow-xl max-w-lg w-full mx-4 p-6 border border-border">
          ...
          <div className="text-center py-4">
            <p className="text-text-secondary mb-4">
              Sign in to import chats from Claude.ai
            </p>
            <button
              onClick={login}
              className="px-4 py-2 bg-white text-gray-700 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors flex items-center gap-2 mx-auto"
            >
