            ...
            >
                <div className="text-center">
                    ...
                    <div className="space-y-3">
                        <button
                            onClick={login}
                            className="w-full px-6 py-3 bg-accent text-white rounded-xl hover:bg-accent-hover transition-all flex items-center justify-center gap-3 font-semibold shadow-lg shadow-accent/20 hover:scale-[1.02] active:scale-[0.98]"
                        >
